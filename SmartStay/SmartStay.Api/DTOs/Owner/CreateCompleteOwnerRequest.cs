/// <copyright file="CreateCompleteOwnerRequest.cs">
/// Copyright (c) 2024 Enrique Rodrigues. All Rights Reserved.
/// </copyright>
/// <file>
/// This file defines the <see cref="CreateCompleteOwnerRequest"/> class, a data transfer object (DTO) used to
/// encapsulate owner creation request details. It ensures a standardized format for incoming owner data.
/// </file>
...
{
/// <summary>
/// Represents the data required to create a new complete owner.
/// </summary>
public class CreateCompleteOwnerRequest
{
    /// <summary>

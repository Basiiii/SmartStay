...
O método \texttt{Export} permite exportar a lista atual de clientes para uma string JSON, que pode ser armazenada num ficheiro ou enviada para outros sistemas. A implementação do método é simples:
